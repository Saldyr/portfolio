    ...
    <>
      ...
      <main className="container-page flex flex-1 flex-col gap-(--gap-section) pb-[90px] pt-(--gap-section)">
        <section className="flex flex-col gap-(--space-l) pb-6.25 pt-10">
          <div className="font-mono text-[13px] font-medium uppercase tracking-(--tracking-caps) text-(--text-muted)">
            Romain Cartia <span className="text-accent">//</span>  Développeur full-stack <span className="text-accent">IA</span>
          </div>
